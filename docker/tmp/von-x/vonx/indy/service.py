...
class IndyService(ServiceBase):
    ...
    def _get_verkey(self, did: str, agent_id: str):
        """
        Obtain the verkey for a particular did

        Args:
            did: the did you wish to obtain a verkey for
        """
        ...
        if did.startswith("did:sov:"):
            ...
            short_did = did
            did = "did:sov:" + short_did

        LOGGER.debug("Fetching verkey for DID '%s' from ledger", did)
        nym_info = self._resolve_nym(short_did, agent_id)
